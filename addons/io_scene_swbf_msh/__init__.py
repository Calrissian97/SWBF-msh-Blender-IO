bl_info = {
    ...
    'warning': '',
    'wiki_url': "https://github.com/Calrissian97/SWBF-msh-Blender-IO/blob/master/docs/reference_manual.md",
    'tracker_url': "https://github.com/Calrissian97/SWBF-msh-Blender-IO/issues",
    'support': 'COMMUNITY',
